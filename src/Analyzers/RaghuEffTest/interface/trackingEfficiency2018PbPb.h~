  ...
  if( collectionName.compare("general") == 0 )
    {
      ...
      //else trkEff = TFile::Open((filePath + "General_TrackEff_3D_nhits0_nopTResChi2_V0.root").c_str(),"open");
      else trkEff = TFile::Open((filePath + "General_TrackEff_3D_nhits0_nopTResChi2_V0.root").c_str());
      //else trkEff = TFile::Open(Form("%s/General_TrackEff_3D_nhits0_nopTResChi2_V0.root", filePath.c_str()), "open");
      
      std::cout<<"trk eff file is: "<<trkEff->GetName()<<std::endl;
      ...
      else
	{
      ...
      //else trkFake = TFile::Open( (filePath + "General_TrackEff_3D_nhits0_nopTResChi2_V0.root").c_str(),"open");
      else trkFake = TFile::Open( (filePath + "General_TrackEff_3D_nhits0_nopTResChi2_V0.root").c_str());
      //else trkFake = TFile::Open(Form("%s/General_TrackEff_3D_nhits0_nopTResChi2_V0.root", filePath.c_str()), "open");
